...
Головна, Моделі, Гаманець, Журнали, Налаштування — загалом п'ять видів. Скріншоти в повній роздільності в [docs/image/](../docs/image/).
