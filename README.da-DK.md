...
<p align="center" style="font-weight: bold;">
  ModelBus-P2P : En decentral LLM-token-deling-platform
</p>
<p align="center">
Måske verdens første platform, hvor alle kan knytte deres Token til et P2P-netværk og til gengæld bruge andre peers' delte Tokens. Ingen central server, ingen kontooprettelse, ingen API-nøgle forlader nogensinde din maskine.
</p>
