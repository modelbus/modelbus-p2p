...
<p align="center">
Можливо, перша у світі платформа, де кожен може під'єднати свій токен до P2P-мережі й натомість використовувати токени, які поширюють інші піри. Без центрального сервера, без реєстрації облікового запису, жоден API-ключ ніколи не залишає вашу машину.
</p>

> ⚠️ **Статус проєкту (v1 тест)**: ModelBus-P2P все ще в розробці та публічному тестуванні. Компоненти дротового формату (протокол `/modelbus/inference/1.0.0`, схема оголошень вузлів v2, список коренів довіри) можуть у майбутньому отримати несумісні оновлення; піри, оголошені зі старими версіями, можуть потребувати повторної реєстрації.
...
- [节点公告格式（v2）](#节点公告格式v2)
- [调用流程详解](#调用流程详解)
- [Завантаження та використання (скоро)](#завантаження-та-використання-скоро)
- [目录结构](#目录结构)
- [快速开始](#快速开始)
- [配置说明](#配置说明)
- [开发与调试](#开发与调试)
...
## Завантаження та використання (скоро)
