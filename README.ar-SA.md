...
<p align="center">
ربما أول منصة في العالم يربط فيها anyone رمز Token بشبكة P2P ويستخدم رموز Token المشتركة من الأقران الآخرين. لا خادم مركزي، لا تسجيل حساب، ولا مفتاح API يخرج من جهازك أبداً.
</p>

> ⚠️ **حالة المشروع (إصدار اختبار v1)**: ModelBus-P2P لا يزال في مرحلة التطوير والاختبار العام. قد تتلقى مكونات تنسيق الاتصال (بروتوكول `/modelbus/inference/1.0.0`، ومخطط إعلان العقدة v2، وقائمة جذور الثقة) تحديثات غير متوافقة في المستقبل؛ قد يحتاج الأقران المُعلَن بهم في الإصدارات القديمة إلى إعادة التسجيل.
...
- [节点公告格式（v2）](#节点公告格式v2)
- [调用流程详解](#调用流程详解)
- [التحميل والاستخدام (قريباً)](#التحميل-والاستخدام-قريباً)
- [目录结构](#目录结构)
- [快速开始](#快速开始)
- [配置说明](#配置说明)
- [开发与调试](#开发与调试)
