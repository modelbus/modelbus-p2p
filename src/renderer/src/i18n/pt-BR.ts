...
export const ptBR: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Cabeçalho de autenticação',    trustHint: 'Os nós abaixo vêm do endpoint oficial ou do cache local. Quatro raízes hard-coded são as âncoras de confiança do cold start.',
