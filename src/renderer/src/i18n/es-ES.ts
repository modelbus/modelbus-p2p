...
export const esES: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Cabecera de autenticación',    trustHint: 'Los nodos de abajo provienen del endpoint oficial o de la caché local. Cuatro raíces hard-coded son los anclajes de confianza del arranque en frío.',
