...
export const bsBA: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Auth zaglavlje',    trustHint: 'Čvorovi ispod dolaze sa zvaničnog endpointa ili lokalnog keša. Četiri hard-coded korijena su cold-start sidra povjerenja.',
