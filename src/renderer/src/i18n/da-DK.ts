...
export const daDK: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Auth-header',    trustHint: 'Noderne nedenfor kommer fra den officielle endpoint eller den lokale cache. Fire hard-kodede rødder er cold-start-tillidsankre.',
    trustBadge: 'Tillid',
