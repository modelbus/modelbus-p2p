...
export const nbNO: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Auth-header',    trustHint: 'Nodene nedenfor kommer fra den offisielle endpointen eller den lokale cachen. Fire hardkodede røtter er cold-start-tillitsankre.',
    trustBadge: 'Tillit',
