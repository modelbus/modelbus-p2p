...
export const plPL: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Nagłówek autoryzacji',    trustHint: 'Poniższe węzły pochodzą z oficjalnego endpointu lub lokalnej pamięci podręcznej. Cztery zakodowane na stałe rooty są kotwicami zaufania cold startu.',
    trustBadge: 'Zaufanie',
