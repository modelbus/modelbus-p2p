...
export const deDE: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Auth-Header',    trustHint: 'Die unten gelisteten Knoten stammen vom offiziellen Endpoint oder aus dem lokalen Cache. Vier fest kodierte Wurzeln sind die Cold-Start-Vertrauensanker.',
