...
export const enUS: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Auth header',    trustHint: 'The nodes below came from the official endpoint or the on-disk cache. Four hard-coded roots are the cold-start trust anchors.',
    trustBadge: 'Trust',
