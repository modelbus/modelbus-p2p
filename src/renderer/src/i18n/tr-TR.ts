...
export const trTR: Dict = {
  ...
  settings: {
    ...
    authHeader: 'Kimlik doğrulama başlığı',    trustHint: 'Aşağıdaki düğümler resmi endpoint\'ten veya yerel önbellekten geldi. Dört hard-coded kök, cold-start güven çıpasıdır.',
    trustBadge: 'Güven',
